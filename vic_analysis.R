...
ggsave("vic_time_series.png", p_time_series, width = 12, height = 8)
...
ggsave("vic_monthly_stats.png", p_monthly, width = 12, height = 8)
...
create_spatial_map <- function(data, name) {
  ...
  ggsave(paste0("vic_", tolower(gsub(" ", "_", name)), "_map.png"), p, width = 10, height = 8)
}
